...
export const JC_MCQ_QUESTIONS: JCMCQQuestion[] = [
  ...
  // ─── CISCE Competency-Focused MCQs ──────────────────────────────────────
  {
    id: "mcq-41",
    question: "Mark Antony stirs the emotions of the crowd in his ____.",
    options: [
      "farewell speech",
      "eulogy",
      "prologue",
    ...
    correctIndex: 1,
    explanation: "Antony delivers a eulogy — a speech honouring the dead — at Caesar's funeral. Through it, he skilfully manipulates the crowd's emotions to turn them against the conspirators.",
  },
  {
    id: "mcq-42",
    question: "\"O world, thou wert the forest to this hart, and this indeed, O world, the heart of thee.\" Which of the following uses the same literary device as given above?",
    options: [
      "The bees buzzed around the flower-filled garden.",
      "Her eyes are buttons.",
      "She caught the scent of mothballs in the abandoned home.",
      "Broken pencils are pointless.",
    ],
    correctIndex: 3,
    explanation: "The original line uses a pun (hart/heart). 'Broken pencils are pointless' similarly uses a pun — pointless meaning both lacking a point and being futile.",
  },
  {
    id: "mcq-43",
    ...
    correctIndex: 1,
    explanation: "It is hearing Caesar's will — which left money and parks to the citizens — that causes the people to feel such reverence for Caesar that they want to kiss his wounds.",
  },
  {
    id: "mcq-44",
    question: "What is the attitude of the mob in the Forum scene?",
    options: [
      "clever",
      "intelligent",
      "sensitive",
    ...
    correctIndex: 3,
    explanation: "The mob is easily swayed — first by Brutus's logic, then by Antony's emotional rhetoric. Their quick shifts reveal an irrational, fickle nature.",
  },
  {
    id: "mcq-45",
    question: "Which of the following is NOT an example of irony?",
    options: [
      "Cassius calls Caesar a God while describing how weak he was.",
      "Antony refers to Brutus as an honourable man while disproving his claims.",
      "One of the plebeians suggested crowning Brutus king.",
      "Antony compares the conspirators' killing of Caesar to apes and hounds.",
    ],
    correctIndex: 3,
    explanation: "Antony's comparison of the conspirators to apes and hounds is a vivid metaphor/imagery expressing his rage, not irony. The other three all say one thing while meaning the opposite.",
  },
  {
    id: "mcq-46",
    question: "Which of the following sentences does Mark Antony NOT use to describe Lepidus in Act IV Scene I?",
    options: [
      "He needs to be taught and trained.",
      "High-spirited fellow with ideas of his own.",
      "He follows trends and fashion.",
      "He is a piece of property.",
    ],
    correctIndex: 1,
    explanation: "Antony dismisses Lepidus as a mere tool — someone to be trained, a follower, and property. He never calls Lepidus a 'high-spirited fellow with ideas of his own'; that would contradict his contempt.",
  },
  {
    id: "mcq-47",
    question: "What opinion does Octavius hold about Lepidus?",
    options: [
      "He is industrious.",
      "He is responsible.",
      "He is a good statesman.",
      "He is a tried and valiant soldier.",
    ],
    correctIndex: 3,
    explanation: "Unlike Antony who despises Lepidus, Octavius defends him as 'a tried and valiant soldier', showing he values Lepidus's military experience.",
  },
  {
    id: "mcq-48",
    question: "Brutus and Cassius did not argue in front of their men because:",
    options: [
      "they did not want an audience.",
      "they did not want to demoralise their troops.",
      "they wanted witnesses to collaborate in their discussion.",
      "they wanted to discuss in a calm environment.",
    ],
    correctIndex: 1,
    explanation: "Brutus insists they move inside his tent because open quarrelling between commanders would undermine morale and discipline among their soldiers.",
  },
  {
    id: "mcq-49",
    question: "Brutus does not allow his pain and anguish to interrupt his professional life. This portrays that he practices _________.",
    options: [
      "stoicism",
      "cynicism",
      "buddhism",
    ...
    correctIndex: 0,
    explanation: "Stoicism teaches mastery over emotions. Brutus conceals his grief over Portia's death to focus on the war, a classic example of stoic self-control.",
  },
  {
    id: "mcq-50",
    question: "\"O Cassius, you are yoked with a lamb.\" (Act V) Which of the following uses the same literary device as given above?",
    options: [
      "The man fought as bravely as a lion.",
      "His voice is velvet.",
      "The sky was dotted with fluffy, white clouds.",
      "The juicy apple tasted sweet.",
    ],
    correctIndex: 1,
    explanation: "The original line is a metaphor — Brutus directly calls himself a lamb. 'His voice is velvet' is also a metaphor (voice = velvet). Option (a) is a simile (uses 'as').",
  },
  {
    id: "mcq-51",
    question: "What feeling does Cassius's words convey when he refers to Octavius as 'a peevish schoolboy' and to Antony as 'a masker and a reveller'?",
    options: [
      "fear",
      "disdain",
      "worry",
    ...
    correctIndex: 1,
    explanation: "By calling Octavius a 'peevish schoolboy' and Antony a 'masker and reveller', Cassius expresses scorn and contempt — disdain for opponents he considers unworthy.",
  },
  {
    id: "mcq-52",
    question: "Which of the given options lists the sequence of events at the Battle of Philippi in the correct order?\n(i) Brutus's army inflicts an early defeat on Octavius' troops.\n(ii) Cassius sends Titinius to check if nearby troops are friend or foe.\n(iii) Cassius learns his camp has been surrounded by Antony's soldiers.\n(iv) Pindarus reports that Titinius has been taken captive.\n(v) Cassius instructs Pindarus to climb a hill to watch Titinius.",
    options: [
      "(ii), (iv), (iii), (v), (i)",
      "(iv), (v), (i), (iii), (iv)",
      "(i), (v), (ii), (iv), (iii)",
    ...
    correctIndex: 3,
    explanation: "First Brutus defeats Octavius (i), then Cassius's camp is attacked (iii), he sends Titinius (ii), orders Pindarus up the hill (v), and Pindarus misreports (iv).",
  },
  {
    id: "mcq-53",
    question: "Cassius's reference to ravens, crows and kites taking the place of two mighty eagles that accompanied their armies from Sardis tells us that he is ________.",
    options: [
      "filled with superstitious dread",
      "an expert bird watcher",
      "happier in the company of birds",
      "not a believer in superstition",
    ],
    correctIndex: 0,
    explanation: "Cassius, who was once an Epicurean dismissing omens, now interprets the carrion birds replacing eagles as a bad sign — showing he is filled with superstitious dread before battle.",
  },
  {
    id: "mcq-54",
    question: "In Act V, Scene IV, Lucilius pretends to be Brutus and is taken captive. His action reveals his _________________.",
    options: [
      "loyalty to Octavius",
      "desire to escape",
      "loyalty to Brutus",
    ...
    correctIndex: 2,
    explanation: "Lucilius impersonates Brutus to give the real Brutus time to escape. This self-sacrificing act demonstrates his deep loyalty to Brutus.",
  },
  {
    id: "mcq-55",
    question: "To whom does Brutus refer when he says, \"Are yet two Romans living such as these? The last of all the Romans, fare thee well!\"?",
    options: [
      "Antony and Octavius",
      "Cassius and Titinius",
      "Pindarus and Lucius",
      "Strato and Lucillius",
    ],
    correctIndex: 1,
    explanation: "Brutus speaks these words upon finding Cassius and Titinius dead. He calls them 'the last of all the Romans', honouring their nobility and sacrifice.",
  },
  {
    id: "mcq-56",
    ...
    options: [
      "Statement II illustrates Statement I.",
      "Statement II contradicts Statement I.",
      "Statement I is true, and Statement II is false.",
      "Statement I is false, and Statement II is true.",
    ],
    correctIndex: 1,
    explanation: "Stoicism considers suicide to avoid hardship as weakness. Brutus earlier condemns Cato's suicide as cowardly, yet he does the same — his action contradicts his stated stoic beliefs.",
  },
  {
    id: "mcq-57",
    question: "Cassius and Brutus make up their minds to die rather than be taken as prisoners. What trait of character is revealed in their behaviour?",
    options: [
      "Pride",
      "Sadism",
      "Resignation",
    ...
    correctIndex: 0,
    explanation: "Both generals choose death over the humiliation of being paraded as captives. This reveals their pride — they value their honour and dignity above survival.",
  },
];
